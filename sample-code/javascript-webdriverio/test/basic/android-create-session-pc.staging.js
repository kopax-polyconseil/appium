...
androidOptions.capabilities.app = join(__dirname, '../../../apps/app-staging-android.apk');
...
describe('Create Android session', function () {
  ...
  it('should create and destroy a session', async function () {
    ...
    assert.equal(current_package, 'app.passculture.staging');


    const element = await client.$('#Tout accepter').click();
      //*[@text='Tout accepter']
